fn bit_padding(msg: &mut Vec<u8>, len: usize) {
    msg.push(1);
...
fn pkcs7_padding(msg: &mut Vec<u8>, len: usize) {
...
mod tests {
    ...
    fn nit_padding_test() {
       ...
       assert_eq!(msg, vec![0x0a, 0x0b, 0x0c, 0x0d, 0x0e, 0x0f, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00]);
